...
export const Map = () => {
  const [_, setZone] = React.useState("");
      ...
      >
        <g className="layer">
          ...
          >
            <ZoneButton
              zone="B"
              d="m425.08,818.63c0,0 26.39,-4.01 26.93,14.69c0.54,18.7 0.54,23.5 0.44,23.36c-0.1,-0.14 2.79,10.29 -20.36,10.29c-23.16,0 -210.57,0 -210.67,-0.14c-0.1,-0.14 -23.06,2.55 -23.06,-13.21c0,-15.76 0.54,-24.31 0.44,-24.45c-0.1,-0.14 -2.05,-11.34 23.8,-11.34c25.85,0 202.49,0.8 202.49,0.8z"
              fill="#d3d3d3"
              id="svg_3"
              stroke="#000000"
              strokeWidth="3"
